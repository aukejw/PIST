...
To study the effectiveness of different machine learning methods in real life
...
To work on this we built a specific framework which would enable us to manage
the learning process and obtain data for evaluation. 
...
to learn to walk on a NAO robot. A basic genetic algorithm contains at least the following:
\begin{itemize} 
